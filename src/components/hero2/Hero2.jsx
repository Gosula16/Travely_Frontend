      ...
      <div class="md:px-36 px-8 md:py-28 py-5">
        <div class="flex lg:flex-row flex-col grid-cols-2 gap-10">
          <div class="flex flex-col gap-5 justify-center p-5">
            ...
            <p class="mt-4">
             "Where every trip is a story, and every destination feels like home."
            </p>
            <Link to="/tours/home" className="get-started-btn"><button className="bg-black text-white px-2 py-3 rounded-lg hover:bg-white hover:border hover:text-black hover:font-bold mt-4">
              Get started
            </button></Link>
          </div>
          <div class="">
